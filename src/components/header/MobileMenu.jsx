            ...
            {navLinks.map((link) => (
              <div key={link.id} className="menu-item">
                <Link
                  ...
                  onClick={() => setIsMobMenuOpen(false)}
                  className="flex items-center text-red-700 hover:text-white capitalize font-medium text-lg py-2 px-4 rounded-lg hover:bg-red-700 transition-all duration-300"
                >
                  {/* {getIcon(link.title)} */}
                  {link.title}
                </Link>
