    ...
    <div className="flex items-center space-x-4">
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex font-medium text-red-800 items-center space-x-1 text-sm px-4 py-[10px] rounded-lg cursor-pointer bg-gradient-to-l from-red-200 to-red-50 hover:from-red-50 hover:to-red-200 transition-colors duration-300"
        >
